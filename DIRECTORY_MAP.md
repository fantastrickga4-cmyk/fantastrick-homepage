...
│  │  ├─ reviews\       ← 후기 목록·작성
│  │  ├─ business\      ← 비즈니스(B2B) — 테마 제어기·매장 운영 프로그램 판매 페이지.
│  │  │                   page.tsx(손실 계산기·모듈 스테퍼 등 상호작용) + business.css(전 규칙 .bizsys 안에 가둠)
│  │  │                   ⚠️ 카피 규칙(이모지0·장치/제어기/세팅·"작동을 안 한다")은 page.tsx 상단 주석 참고
